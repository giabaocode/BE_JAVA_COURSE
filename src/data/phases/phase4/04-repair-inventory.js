...
<em>"State machine" nói đơn giản: phiếu sửa chỉ được đi theo những con đường CHO PHÉP — như quân cờ đi theo luật, không nhảy lung tung. Vd nhận máy xong phải chẩn đoán, KHÔNG nhảy thẳng sang "đã trả máy".</em>
...
<h3>Tech stack</h3>
<em>(Đừng thấy danh sách dài mà ngợp — TẤT CẢ công nghệ dưới đây bạn ĐÃ học ở Phase 3. Capstone A chỉ là ráp chúng lại thành 1 app thật.)</em><br/>
Java 21 · Spring Boot 3.x · PostgreSQL 16 · Docker Compose · Flyway (tạo bảng theo phiên bản) · Spring Security/JWT (đăng nhập + phân quyền) · JPA (ánh xạ object↔bảng) · Bean Validation (kiểm input) · GlobalExceptionHandler (trả lỗi chuẩn ProblemDetail) · Swagger (tài liệu API tự sinh) · Testcontainers + JUnit/Mockito (test).`
      },
      theory: {
