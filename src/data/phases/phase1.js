...
<ul>
  ...
  <li><strong>Custom data structure</strong> (sort linked list, sort theo nhiều criteria phức tạp) — đôi khi tự viết tốt hơn.</li>
    ...
    // ========================================================================
    // Module 1.8 — OOP Mini Projects (Vietnamese-style CRUD console apps)
    // Mục tiêu: GHÉP OOP + collections + sorting vào 3 app gần với business thật.
    // Đây là kiểu bài tập Cybersoft hay dùng — luyện refactor procedural → OOP.
    // ========================================================================
    {
      id: 'mod-1-8',
