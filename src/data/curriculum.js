...
export const curriculum = {
  meta: {
    ...
    tagline: 'OOP + memory model → 17 LeetCode patterns → Docker + Spring Boot → Capstones → AI mentor.',
    durationWeeks: 24,
    philosophy: {
      en: 'Master the mental model first. Code is the artifact, not the goal.',
      vi: 'Hiểu mô hình tư duy trước, code chỉ là sản phẩm cuối. Mọi khái niệm phải tự diễn giải được bằng lời trước khi viết bất kỳ dòng code nào.'
    }
  },
